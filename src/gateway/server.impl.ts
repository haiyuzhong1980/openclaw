...
export async function startGatewayServer(
  ...
  let taskTerminalNotifier: TaskTerminalNotifierHandle | null = null;
  ...
  if (!minimalTestGateway) {
    ({ browserControl, pluginServices, taskTerminalNotifier } = await startGatewaySidecars({
      cfg: cfgAtStart,
      pluginRegistry,
      defaultWorkspaceDir,
      deps,
